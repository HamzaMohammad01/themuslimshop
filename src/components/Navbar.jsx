...
export default function Navbar() {
	...
	return (
		<div
			ref={navRef}
			className={
				"border-2 rounded-2xl h-fit w-20 z-50 ml-2 flex flex-col items-center p-1 space-y-5 pt-10 fixed xs:space-y-0 xs:border-0 xs:bg-primary xs:bottom-0 xs:w-full xs:flex-row xs:justify-around xs:ml-0 xs:p-5 top-[18%] xs:top-auto"
			}
		>
			<Link to={"/"}>
